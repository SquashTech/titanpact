...
const NOTES: Partial<Record<SfxId, string>> = {
  ...
  cast: 'the "X uses Y" beat — the wind-up; the element lands under the hit',
  'cast.Fire': 'the element landing — a gust catching, then crackle',
  'cast.Water': 'a splash and two drops',
  'cast.Frost': 'ice forming: bells, a brittle tick, cold hiss',
  'cast.Storm': 'the crack, then the thunder 40ms behind it',
  'cast.Stone': 'a rockfall: one thud, two tumbling after',
  'cast.Nature': 'leaves in a gust',
  'cast.Light': 'radiance rising, no low end',
  'cast.Shadow': 'a dark swell and a falling whisper',
  'cast.Arcane': 'a detuned saw opening, bells, glitter',
  'cast.Mind': 'wide-detuned pairs beating — a warble',
  'cast.Spirit': 'ethereal fifths, nothing struck',
  'cast.Iron': 'a swipe, then steel ringing',
  'cast.Mech': 'a servo whirring up, then a lock',
  'cast.Beast': 'a snarl',
  'cast.Ancient': 'a gong — the one cast allowed to outlast its beat',
