 ...
 */
export function ShopNodeScreen({ run, offers, onRunChange, onBuyEquipment, onContinue }: Props) {
  return (
    <div className="node-screen">
      <div className="screen-scroll">
        <GuildHallPanel run={run} offers={offers} onRunChange={onRunChange} onBuyEquipment={onBuyEquipment} />
      </div>
