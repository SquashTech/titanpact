...
import { ELDER_BOUGH_ID, ENDBRINGER_ID, MANTICORE_ID, DRAGON_ID, KRAKEN_ID, SERAPH_ID, SKELETON_KING_ID, YUGZULACH_ID, LEFT_EYE_ID, RIGHT_EYE_ID } from '../../data/enemies';
