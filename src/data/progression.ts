        ...
        paths: [
          {
            ...
            kind: 'offensive',
            name: 'Ravener',
            description: 'Drops the patience and just runs the target down.',
            statGrants: { attack: 20, speed: 10 },
            unlocksMoveIds: ['rampage'],
            typeGraft: 'Beast',
            learnableMoveIds: ['pounce', 'lacerate', 'maul', 'eviscerate', 'apexPredator'],
          },
          {
            ...
            kind: 'defensive',
            name: 'Penumbra',
            description: 'Never quite finishes arriving, so there is never quite anything to hit.',
          ...
          },
          {
            ...
            kind: 'utility',
            name: 'Belladonna',
            description: 'Stops carrying the knife and becomes the thing on it.',
            statGrants: { attack: -30, intelligence: 40, wisdom: 20 },
            unlocksMoveIds: ['umbralBeam'],
            typeGraft: 'Nature',
            learnableMoveIds: ['toxicSpores', 'blight', 'corrode', 'umbralWave', 'eclipse'],
          },
        ],
      },
    ],
