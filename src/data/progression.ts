    ...
    tidecaller: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            kind: 'utility',
            name: 'Maelstrom',
            description: 'Charges the water it throws, then cashes the charge with the storm.',
            statGrants: {},
            unlocksMoveIds: ['shockBubble'],
            typeGraft: 'Storm',
            learnableMoveIds: ['jolt', 'chainLightning', 'electricBurst', 'thunderbolt'],
    ...
    runescribe: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            kind: 'defensive',
            name: 'Verdance',
            description: 'Writes into living wood, which grows back over the wounds.',
            statGrants: { hp: 40, defense: 10, wisdom: 10 },
            unlocksMoveIds: ['magicGrowth'],
            typeGraft: 'Nature',
            learnableMoveIds: ['regrowth', 'vineLash', 'wildBloom', 'overgrowth', 'forceOfNature'],
          },
          {
    ...
    mindweaver: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            kind: 'defensive',
            name: 'Torpor',
            description: 'Slows the whole field to its own pace and simply outlasts it.',
            statGrants: { defense: 20, hp: 20, wisdom: 10 },
            unlocksMoveIds: ['permafrost'],
            typeGraft: 'Frost',
            learnableMoveIds: ['frostArmor', 'deepChill', 'glaciate', 'frostWall', 'absoluteZero'],
          },
          {
