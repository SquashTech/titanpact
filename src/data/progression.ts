...
export const progressionTable: ProgressionTable = {
  moveTiers: {
    ...
    // --- Mech ---
    forgewright: ['backfire', 'overheat', 'malfunction', 'meltdown', 'salvage', 'juryRig', 'cogBop', 'reinforce', 'undertow', 'singe', 'ironFist', 'rockToss', 'cogSlam', 'jackpot', 'overdrive', 'perfectCreation'],
    steamColossus: [
      'swiftBlow',
      'pistonPunch',
      'cogSlam',
    ...
    stormRanger: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            statGrants: { hp: 80, defense: 10, wisdom: 10 },
        ...
        paths: [
          {
            ...
            statGrants: { attack: 30, intelligence: -20, defense: 10, hp: 40 },
    ...
    dawnwarden: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            statGrants: { defense: 20, hp: 40, wisdom: 10 },
    ...
    lucius: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            statGrants: { hp: 80, defense: 10, wisdom: 20 },
            unlocksMoveIds: [],
    ...
    trance: [
      {
        ...
        paths: [
          ...
          },
          {
            ...
            statGrants: { hp: 60, wisdom: 20, manaPool: 20 },
            unlocksMoveIds: ['magicCloak'],
            typeGraft: 'Arcane',
