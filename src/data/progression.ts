...
export const progressionTable: ProgressionTable = {
  moveTiers: {
    ...
    pincer: ['aquaSlice', 'waveShred', 'washAway', 'shockBubble', 'rendArmor', 'refresh', 'ironFist', 'heavyBlow', 'serratedSlice'],
    // --- Frost ---
    ...
    sentinel: ['bodyBlow', 'bastion', 'retribution', 'boulderSlam', 'stoneheart', 'toughenUp', 'rally', 'faultLine'],
    // --- Nature ---
    ...
    aegis: ['holySlice', 'blind', 'purify', 'bless', 'exalt', 'consecrate', 'divineGrace', 'reinforce'],
    // --- Shadow ---
    shadowMonk: ['backstab', 'weaken', 'ambush', 'shadowSlice', 'rend', 'duskBlade', 'claw', 'shadowstrike'],
    marrow: ['vanish', 'umbralBeam', 'umbralWave', 'poltergeist', 'enfeeble', 'drain', 'torment', 'soulRend'],
