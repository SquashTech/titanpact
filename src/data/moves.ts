...
export const moves: Record<string, MoveDefinition> = {
  ...
  ember: {
    ...
    kind: 'damage',
    basePower: 40,
    statusApplication: { statusId: 'Burn', magnitude: 10, target: 'moveTarget', chance: 0.1 },
    manaCost: 20,
    priority: 0,
    target: 'singleEnemy',
  ...
  sparkBurst: {
    ...
    category: 'magical',
    kind: 'buff',
    statusApplication: { statusId: 'Burn', magnitude: 75, target: 'moveTarget' },
    manaCost: 65,
    priority: 0,
    target: 'bothEnemies',
  ...
  volcanicSurge: {
    ...
    kind: 'damage',
    basePower: 120,
    statusApplication: { statusId: 'Burn', magnitude: 60, target: 'self' },
    manaCost: 65,
    priority: 0,
    target: 'singleEnemy',
  ...
  secondWind: {
    ...
    kind: 'buff',
    statDeltas: [],
    statusApplication: { statusId: 'Renew', magnitude: 45, target: 'self' },
    manaCost: 30,
    priority: 0,
    target: 'self',
