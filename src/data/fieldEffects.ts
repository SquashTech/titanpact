...
export const fieldEffects: Record<string, FieldEffectDefinition> = {
  ...
  scorchedLand: {
    id: 'scorchedLand',
    name: 'Scorched Land',
    description: 'Burn no longer decays — it keeps dealing its full damage every round instead of halving.',
    flavorType: 'Fire',
  ...
  stasisBubble: {
    id: 'stasisBubble',
    name: 'Stasis Bubble',
    description: 'Time drags: within a shared priority bracket, the slowest hero now acts first instead of the fastest. Priority moves are unaffected — they still resolve in their own bracket.',
    flavorType: 'Mind',
  ...
  sanctuary: {
    id: 'sanctuary',
    name: 'Sanctuary',
    description: 'Healing moves gain +1 priority, resolving before ordinary moves.',
    flavorType: 'Light',
    healPriorityBonus: 1,
  },
  verdantEarth: {
