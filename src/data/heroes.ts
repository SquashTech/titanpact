...
export const heroes: Record<string, HeroDefinition> = {
  ...
  cinderKnight: {
    ...
    name: 'Cinder',
    types: ['Fire', 'Iron'],
    baseStats: { hp: 240, attack: 85, defense: 75, intelligence: 25, wisdom: 40, speed: 55, manaPool: 50, mpRegen: 10 },
  ...
  brimstone: {
    ...
    name: 'Brimstone',
    types: ['Fire', 'Shadow'],
    baseStats: { hp: 190, attack: 45, defense: 50, intelligence: 85, wisdom: 50, speed: 60, manaPool: 65, mpRegen: 10 },
  ...
  tidecaller: {
    ...
    name: 'Riptide',
    types: ['Water'],
    baseStats: { hp: 220, attack: 55, defense: 55, intelligence: 59, wisdom: 40, speed: 66, manaPool: 65, mpRegen: 10 },
  ...
  rime: {
    ...
    name: 'Rime',
    types: ['Frost'],
    baseStats: { hp: 220, attack: 65, defense: 55, intelligence: 65, wisdom: 53, speed: 42, manaPool: 60, mpRegen: 10 },
  ...
  stormRanger: {
    ...
    name: 'Squall',
    types: ['Storm'],
    baseStats: { hp: 190, attack: 85, defense: 45, intelligence: 30, wisdom: 40, speed: 105, manaPool: 50, mpRegen: 10 },
  ...
  tempest: {
    ...
    name: 'Tempest',
    types: ['Storm'],
    baseStats: { hp: 180, attack: 70, defense: 45, intelligence: 70, wisdom: 35, speed: 65, manaPool: 75, mpRegen: 10 },
  ...
  scallywag: {
    ...
    name: 'Scallywag',
    types: ['Storm'],
    baseStats: { hp: 220, attack: 95, defense: 50, intelligence: 25, wisdom: 40, speed: 80, manaPool: 50, mpRegen: 10 },
  ...
  wildOracle: {
    ...
    name: 'Sylva',
    types: ['Nature'],
    baseStats: { hp: 160, attack: 45, defense: 60, intelligence: 60, wisdom: 60, speed: 65, manaPool: 80, mpRegen: 10 },
  ...
  mordax: {
    ...
    name: 'Mordrax',
    types: ['Nature'],
    baseStats: { hp: 240, attack: 90, defense: 65, intelligence: 25, wisdom: 45, speed: 55, manaPool: 50, mpRegen: 10 },
  ...
  dawnwarden: {
    ...
    name: 'Solace',
    types: ['Light'],
    baseStats: { hp: 220, attack: 29, defense: 50, intelligence: 60, wisdom: 70, speed: 61, manaPool: 70, mpRegen: 10 },
  ...
  marrow: {
    ...
    name: 'Marrow',
    types: ['Shadow'],
    baseStats: { hp: 190, attack: 30, defense: 50, intelligence: 95, wisdom: 50, speed: 65, manaPool: 65, mpRegen: 10 },
  ...
  nightshade: {
    ...
    name: 'Nightshade',
    types: ['Shadow'],
    baseStats: { hp: 180, attack: 80, defense: 30, intelligence: 65, wisdom: 40, speed: 85, manaPool: 60, mpRegen: 10 },
  ...
  runescribe: {
    ...
    name: 'Glyph',
    types: ['Arcane'],
    baseStats: { hp: 160, attack: 25, defense: 32, intelligence: 90, wisdom: 80, speed: 58, manaPool: 85, mpRegen: 10 },
  ...
  zenith: {
    ...
    name: 'Zenith',
    types: ['Arcane'],
    baseStats: { hp: 190, attack: 20, defense: 45, intelligence: 85, wisdom: 65, speed: 50, manaPool: 90, mpRegen: 10 },
  ...
  revenant: {
    ...
    name: 'Revenant',
    types: ['Spirit'],
    baseStats: { hp: 160, attack: 56, defense: 47, intelligence: 77, wisdom: 46, speed: 64, manaPool: 80, mpRegen: 10 },
  ...
  sorrow: {
    ...
    name: 'Sorrow',
    types: ['Spirit'],
    baseStats: { hp: 160, attack: 95, defense: 45, intelligence: 30, wisdom: 45, speed: 100, manaPool: 55, mpRegen: 10 },
  ...
  valor: {
    ...
    name: 'Valor',
    types: ['Iron'],
    baseStats: { hp: 240, attack: 60, defense: 65, intelligence: 40, wisdom: 45, speed: 60, manaPool: 60, mpRegen: 10 },
  ...
  gallant: {
    ...
    name: 'Gallant',
    types: ['Iron'],
    baseStats: { hp: 220, attack: 95, defense: 60, intelligence: 20, wisdom: 40, speed: 75, manaPool: 50, mpRegen: 10 },
  ...
  forgewright: {
    ...
    name: 'Clockwork',
    types: ['Mech'],
    baseStats: { hp: 260, attack: 60, defense: 70, intelligence: 45, wisdom: 40, speed: 55, manaPool: 50, mpRegen: 10 },
  ...
  widow: {
    ...
    name: 'Widow',
    types: ['Beast', 'Shadow'],
    baseStats: { hp: 180, attack: 100, defense: 45, intelligence: 20, wisdom: 45, speed: 100, manaPool: 50, mpRegen: 10 },
  ...
  coil: {
    ...
    name: 'Coil',
    types: ['Beast', 'Mind'],
    baseStats: { hp: 190, attack: 25, defense: 55, intelligence: 90, wisdom: 60, speed: 60, manaPool: 65, mpRegen: 10 },
