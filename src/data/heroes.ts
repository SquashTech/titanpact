...
export const heroes: Record<string, HeroDefinition> = {
  cinderKnight: {
    ...
    moveIds: ['emberSlash', 'quickJab', 'flareBurst', 'fangRush'],
  },
  tidecaller: {
    id: 'tidecaller',
    name: 'Tidecaller',
    ...
    moveIds: ['tidalBolt', 'aquaJet', 'tsunamiCrash'],
  },
  ironWarden: {
    id: 'ironWarden',
    name: 'Iron Warden',
    ...
    moveIds: ['quickJab', 'boulderToss', 'shrapnelBlast'],
  },
  wildOracle: {
    id: 'wildOracle',
    name: 'Wild Oracle',
    ...
    moveIds: ['wildfire', 'overload', 'vineLash', 'soulRend'],
  },
  stormRanger: {
    id: 'stormRanger',
    name: 'Storm Ranger',
    ...
    moveIds: ['galeShot', 'quickJab', 'thunderclap', 'galeSlash'],
  },
  shadowMonk: {
    id: 'shadowMonk',
    name: 'Shadow Monk',
    ...
    moveIds: ['duskStrike', 'quickJab', 'shadowVeil', 'fangRush'],
  },
};
