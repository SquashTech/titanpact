...
/**
 * A Small Candy off the Guild Hall shelf — one level at par for one hero (run/candy.ts), where
 ...
 */
export const CANDY_PURCHASE_COST = 35;
 ...
 * rather than a dump, and two Smalls is a purchased +2 for one hero — watch it against the 50g
 * hire (docs/xp-overhaul.md §10). First-pass figure for playtest.
 */
export const CANDY_PURCHASE_LIMIT = 2;
