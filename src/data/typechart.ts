...
export const typeChart: TypeChart = buildChart({
  ...
  Storm: { Water: 2, Beast: 2, Stone: 0.5, Ancient: 0.5, Mech: 0.5 },
  Stone: { Fire: 2, Storm: 2, Water: 0.5, Nature: 0.5, Ancient: 0.5 },
  Nature: { Water: 2, Stone: 2, Fire: 0.5, Frost: 0.5, Beast: 0.5, Ancient: 0.5 },
  Light: { Shadow: 2, Frost: 2, Spirit: 0.5, Ancient: 0.5, Fire: 0.5, Nature: 0.5 },
  Shadow: { Light: 2, Mind: 2, Ancient: 0.5, Beast: 0.5, Spirit: 0.5, Stone: 0.5 },
  Arcane: { Mind: 2, Iron: 0.5, Ancient: 0.5, Storm: 2 },
  Mind: { Spirit: 2, Shadow: 0.5, Arcane: 0.5, Ancient: 0.5, Mech: 2 },
  Spirit: { Shadow: 2, Light: 2, Mind: 0.5, Ancient: 0.5 },
  Iron: { Stone: 2, Frost: 2, Mech: 0.5, Ancient: 0.5 },
  Mech: { Iron: 2, Beast: 2, Water: 0.5, Ancient: 0.5, Mind: 0.5 },
  Beast: { Nature: 2, Mech: 0.5, Frost: 0.5, Storm: 0.5, Ancient: 0.5, Mind: 2, Arcane: 2 },
  Ancient: { Mech: 2 },
});
