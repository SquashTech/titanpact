...
export const enemies: Record<string, HeroDefinition> = {
  ...
  goblinGrunt: {
    ...
    name: 'Goblin Grunt',
    types: ['Beast'],
    baseStats: { hp: 100, attack: 35, defense: 25, intelligence: 15, wisdom: 20, speed: 40, manaPool: 40, mpRegen: 10 },
  ...
  goblinSkulker: {
    ...
    name: 'Goblin Skulker',
    types: ['Shadow'],
    baseStats: { hp: 90, attack: 30, defense: 20, intelligence: 15, wisdom: 20, speed: 45, manaPool: 40, mpRegen: 10 },
  ...
  spookyGoblin: {
    ...
    name: 'Spooky Goblin',
    types: ['Spirit'],
    baseStats: { hp: 84, attack: 20, defense: 20, intelligence: 35, wisdom: 30, speed: 42, manaPool: 40, mpRegen: 10 },
    moveIds: ['wisp', 'drain'],
    starter: false,
  },
  goblinWarrior: {
    ...
    name: 'Goblin Warrior',
    types: ['Iron'],
    baseStats: { hp: 110, attack: 35, defense: 35, intelligence: 10, wisdom: 15, speed: 30, manaPool: 40, mpRegen: 10 },
  ...
  torchGoblin: {
    ...
    name: 'Torch Goblin',
    types: ['Fire'],
    baseStats: { hp: 84, attack: 32, defense: 18, intelligence: 25, wisdom: 18, speed: 48, manaPool: 40, mpRegen: 10 },
    moveIds: ['ember', 'singe'],
    starter: false,
  },
  ...
  goblinChief: {
    ...
    name: 'Goblin Chief',
    types: ['Beast'],
    baseStats: { hp: 420, attack: 60, defense: 45, intelligence: 25, wisdom: 35, speed: 50, manaPool: 70, mpRegen: 14 },
  ...
  cultBlade: {
    ...
    name: 'Cult Blade',
    types: ['Shadow', 'Iron'],
    baseStats: { hp: 210, attack: 85, defense: 75, intelligence: 25, wisdom: 45, speed: 65, manaPool: 50, mpRegen: 12 },
  ...
  dreadCultist: {
    ...
    name: 'Dread Cultist',
    types: ['Shadow'],
    baseStats: { hp: 200, attack: 30, defense: 60, intelligence: 90, wisdom: 70, speed: 50, manaPool: 60, mpRegen: 12 },
  ...
  blightedCultist: {
    ...
    types: ['Shadow', 'Nature'],
    baseStats: { hp: 250, attack: 40, defense: 70, intelligence: 80, wisdom: 60, speed: 25, manaPool: 55, mpRegen: 12 },
  ...
  frozenCultist: {
    ...
    name: 'Frozen Cultist',
    types: ['Shadow', 'Frost'],
    baseStats: { hp: 200, attack: 35, defense: 70, intelligence: 90, wisdom: 70, speed: 35, manaPool: 65, mpRegen: 12 },
  ...
  cultMystic: {
    ...
    name: 'Cult Mystic',
    types: ['Shadow', 'Arcane'],
    baseStats: { hp: 290, attack: 40, defense: 75, intelligence: 100, wisdom: 80, speed: 60, manaPool: 100, mpRegen: 16 },
  ...
  pixie: {
    ...
    name: 'Pixie',
    types: ['Nature'],
    baseStats: { hp: 170, attack: 25, defense: 55, intelligence: 85, wisdom: 65, speed: 85, manaPool: 55, mpRegen: 12 },
  ...
  faeWarrior: {
    ...
    name: 'Fae Warrior',
    types: ['Nature', 'Iron'],
    baseStats: { hp: 230, attack: 95, defense: 90, intelligence: 20, wisdom: 40, speed: 40, manaPool: 55, mpRegen: 12 },
  ...
  lightFairy: {
    ...
    name: 'Light Fairy',
    types: ['Nature', 'Light'],
    baseStats: { hp: 200, attack: 25, defense: 65, intelligence: 85, wisdom: 80, speed: 45, manaPool: 65, mpRegen: 12 },
  ...
  mechaFairy: {
    ...
    name: 'Mecha Fairy',
    types: ['Nature', 'Mech'],
    baseStats: { hp: 190, attack: 30, defense: 70, intelligence: 90, wisdom: 55, speed: 60, manaPool: 60, mpRegen: 12 },
  ...
  pixieQueen: {
    ...
    name: 'Pixie Queen',
    types: ['Nature', 'Arcane'],
    baseStats: { hp: 280, attack: 35, defense: 80, intelligence: 105, wisdom: 85, speed: 55, manaPool: 100, mpRegen: 16 },
  ...
  flameSprite: {
    ...
    name: 'Flame Sprite',
    types: ['Fire'],
    baseStats: { hp: 160, attack: 20, defense: 50, intelligence: 90, wisdom: 60, speed: 100, manaPool: 65, mpRegen: 12 },
  ...
  steamSpirit: {
    ...
    name: 'Steam Spirit',
    types: ['Fire', 'Water'],
    baseStats: { hp: 210, attack: 20, defense: 70, intelligence: 85, wisdom: 75, speed: 45, manaPool: 65, mpRegen: 12 },
  ...
  emberLizard: {
    ...
    name: 'Ember Lizard',
    types: ['Fire', 'Beast'],
    baseStats: { hp: 230, attack: 100, defense: 80, intelligence: 20, wisdom: 35, speed: 50, manaPool: 55, mpRegen: 12 },
  ...
  automaton: {
    ...
    name: 'Automaton',
    types: ['Mech'],
    baseStats: { hp: 220, attack: 30, defense: 90, intelligence: 85, wisdom: 45, speed: 40, manaPool: 60, mpRegen: 12 },
  ...
  vulcadozer: {
    ...
    name: 'Vulcadozer',
    types: ['Mech'],
    baseStats: { hp: 330, attack: 110, defense: 100, intelligence: 25, wisdom: 45, speed: 55, manaPool: 100, mpRegen: 16 },
  ...
  skeletonKnight: {
    ...
    types: ['Spirit', 'Iron'],
    baseStats: { hp: 220, attack: 100, defense: 95, intelligence: 20, wisdom: 35, speed: 40, manaPool: 55, mpRegen: 12 },
  ...
  shamblingHusk: {
    ...
    name: 'Shambling Husk',
    types: ['Spirit', 'Nature'],
    baseStats: { hp: 290, attack: 30, defense: 85, intelligence: 70, wisdom: 55, speed: 15, manaPool: 65, mpRegen: 12 },
  ...
  boneConjurer: {
    ...
    name: 'Bone Conjurer',
    types: ['Spirit', 'Mind'],
    baseStats: { hp: 190, attack: 20, defense: 65, intelligence: 100, wisdom: 75, speed: 45, manaPool: 65, mpRegen: 12 },
  ...
  dreadRaven: {
    ...
    name: 'Dread Raven',
    types: ['Beast', 'Shadow'],
    baseStats: { hp: 280, attack: 110, defense: 70, intelligence: 25, wisdom: 60, speed: 95, manaPool: 100, mpRegen: 16 },
  ...
  raider: {
    ...
    name: 'Raider',
    types: ['Iron'],
    baseStats: { hp: 220, attack: 90, defense: 75, intelligence: 20, wisdom: 40, speed: 65, manaPool: 50, mpRegen: 12 },
  ...
  stormRaider: {
    ...
    name: 'Stormraider',
    types: ['Iron', 'Storm'],
    baseStats: { hp: 230, attack: 90, defense: 80, intelligence: 25, wisdom: 40, speed: 50, manaPool: 65, mpRegen: 12 },
  ...
  surfRaider: {
    ...
    name: 'Surfraider',
    types: ['Iron', 'Water'],
    baseStats: { hp: 190, attack: 85, defense: 65, intelligence: 25, wisdom: 45, speed: 85, manaPool: 55, mpRegen: 12 },
  ...
  mysticRaider: {
    ...
    name: 'Mysticraider',
    types: ['Iron', 'Arcane'],
    baseStats: { hp: 200, attack: 30, defense: 70, intelligence: 95, wisdom: 70, speed: 35, manaPool: 65, mpRegen: 12 },
  ...
  championRaider: {
    ...
    types: ['Iron', 'Storm'],
    baseStats: { hp: 300, attack: 110, defense: 90, intelligence: 30, wisdom: 50, speed: 70, manaPool: 100, mpRegen: 16 },
